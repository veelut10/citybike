...
public class RepositorioUsuarioJPA implements RepositorioString<UsuarioEntidad>{
	...
	public String add(UsuarioEntidad entity) throws RepositorioException {
	...
	public void update(UsuarioEntidad entity) throws RepositorioException, EntidadNoEncontrada {
		EntityManager em = EntityManagerHelper.getEntityManager();
		try {
			em.getTransaction().begin();
	...
	public void delete(UsuarioEntidad entity) throws RepositorioException, EntidadNoEncontrada {
		EntityManager em = EntityManagerHelper.getEntityManager();
		try {
			em.getTransaction().begin();
			UsuarioEntidad instance = em.find(getClase(), entity.getId());
	...
	public UsuarioEntidad getById(String id) throws EntidadNoEncontrada, RepositorioException {
		EntityManager em = EntityManagerHelper.getEntityManager();
		try {
	...
	public List<UsuarioEntidad> getAll() throws RepositorioException {
		EntityManager em = EntityManagerHelper.getEntityManager();
		try {
